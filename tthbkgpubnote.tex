...
%-------------------------------------------------------------------------------
\documentclass[PUB, atlasdraft=false, texlive=2017, UKenglish]{\ATLASLATEXPATH atlasdoc} % removed 'coverpage' option for approved version
...
%\tableofcontents.  %remove for approved version
